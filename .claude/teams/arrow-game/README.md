...
**공통 규칙**: 모든 팀원은 작업 시 프로젝트 문서를 참고해야 합니다. 특히 `docs/roles/` 아래 역할별 md, `docs/plan/GamePlan.md`, `docs/plan/TechnicalSpec.md`, `docs/Workflow.md` 등을 필요에 따라 읽고 따릅니다. 작업 시작 시 반드시 `docs/Workflow.md` 1·2절을 확인한 뒤, **브랜치 생성 → Plan(필요 시) → 작업** 순서로 진행한다.
